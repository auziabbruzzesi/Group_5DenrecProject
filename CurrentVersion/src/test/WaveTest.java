...
public class WaveTest {
	...
	public void moveTest() {
		...
		wave.move();
		// checking to see if waves xcoord has decremented, indicates wave has
		// moved west
		assertTrue(wave.getPosition().getX() <= start.getX());

		// checks to see if waves ycoord is the same as the start position,
		// waves only move horizontally.
